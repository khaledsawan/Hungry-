...
import 'package:shop_delivery_system/Services/model/response_model.dart';
...
class PlaceOrderController extends GetxController implements GetxService {
  ...
  Future<void> placeorder(Function callback, PlaceOrderModle placeOrderModle) async {
    _isLoading = true;
    Response response = await orderRepo.Place_Order(placeOrderModle);
