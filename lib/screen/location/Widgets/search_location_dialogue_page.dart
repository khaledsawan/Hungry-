...
class SearchLocationDialoguePage extends StatelessWidget {
  final GoogleMapController MapConroller;
  const SearchLocationDialoguePage({required this.MapConroller, Key? key})
      : super(key: key);
            ...
            child: TypeAheadField(
              ...
              onSuggestionSelected: (Prediction suggestion) async {
                return await Get.find<AddressController>().setLocation(
                    suggestion.placeId!, suggestion.description!, MapConroller);
              },
