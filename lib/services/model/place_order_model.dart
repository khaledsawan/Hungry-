...
class PlaceOrderModle {
  List<CartModle>? _cart;
  ...
  PlaceOrderModle.fromJson(Map<String, dynamic> json) {
    if (json['cart'] != null) {
      _cart = [];
      json['cart'].forEach((v) {
        _cart!.add(new CartModle.fromJson(v));
      });
    }
